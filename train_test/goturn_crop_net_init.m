function net = goturn_crop_net_init()
% input:
%       -target :H*W*3
%       -image :H*W*3
% output:
...
SampleGenerator = dagnn.SampleGenerator('Ho',227,'Wo',227,'No',50,'averageImage',net.meta.normalization.averageImage,'visual',ismac());
...
net.addLayer('conv1', conv1, {'image_target_crop'}, {'conv1'}, {'filters1', 'biases1'}) ;
...
net.addLayer('conv1_p', conv1_p, {'image_search_crop'}, {'conv1_p'}, {'filters1', 'biases1'}) ;
