...
bbox_estimate_uncentered(1) = max(0,bbox_estimate_unscaled(1)+search_location(1)-edge_spacing_x);
bbox_estimate_uncentered(2) = max(0,bbox_estimate_unscaled(2)+search_location(2)-edge_spacing_y);
