...
function [state, location] = goturn_update(state, I, varargin)
    ...
    [bbox_estimate,state.pooling5] = regressor_regress(state.net,state.pooling5,curr_search_region,target_pad);
    ...
    bbox_estimate_uncentered = mean(cell2mat(bbox_estimate_uncentered),1);
    state.image_prev = I;
